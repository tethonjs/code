...
HTMLCanvasElement.prototype.background = function (prop) {
    this.getContext("2d").fillStyle = prop;
};
HTMLCanvasElement.prototype.getBackground = function () {
    return this.getContext("2d").fillStyle;
};
