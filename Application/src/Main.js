        ...
        window.onkeydown = function(event){
            ...
            if(event.keyCode === 32){
                if(!Player.hasAnimation())
                    Player.addAnimation(["../images/Jungle Asset Pack/Character/run/1.png", "../images/Jungle Asset Pack/Character/run/2.png", "../images/Jungle Asset Pack/Character/run/3.png", "../images/Jungle Asset Pack/Character/run/4.png", "../images/Jungle Asset Pack/Character/run/5.png", "../images/Jungle Asset Pack/Character/run/6.png", "../images/Jungle Asset Pack/Character/run/7.png"], 100);
